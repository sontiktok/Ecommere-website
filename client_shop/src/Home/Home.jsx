                          ...
                          <div className="row align-items-stretch mb-4">
                            <div className="col-sm-5 pl-sm-0 fix_addwish">
                              <a className="btn btn-dark btn-sm btn-block h-100 d-flex align-items-center justify-content-center px-0">
                                <i className="far fa-heart mr-2"></i>Add Too
                                Wish List
                              </a>
                            </div>
                          </div>
            ...
            <div className="row">
              <div className="col-md-4 mb-4 mb-md-0">
                <Link className="category-item" to={"/shop"}>
                  ...
                  <strong className="category-item-title">Quần áo</strong>
                </Link>
              </div>
              <div className="col-md-4 mb-4 mb-md-0">
                <Link className="category-item mb-4" to={"/shop"}>
                  <img className="img-fluid" src={Image.img2} alt="" />
                  <strong className="category-item-title">Giày</strong>
                </Link>
                <Link className="category-item" to={"/shop"}>
                  <img className="img-fluid" src={Image.img3} alt="" />
                  <strong className="category-item-title">Đồng hồ</strong>
                </Link>
              </div>
                  ...
                  <div className="d-inline-block">
                    <div className="media align-items-end">
                      ...
                      <div className="media-body text-left ml-3">
                        <h6 className="text-uppercase mb-1">Phí vận chuyển</h6>
                ...
                <div className="col-lg-4 mb-3 mb-lg-0">
                  <div className="d-inline-block">
                    <div className="media align-items-end">
                      ...
                      <div className="media-body text-left ml-3">
                        <h6 className="text-uppercase mb-1">Dịch vụ 24/7</h6>
                        <p className="text-small mb-0 text-muted">
                ...
                <div className="col-lg-4">
                  <div className="d-inline-block">
                    <div className="media align-items-end">
                      ...
                      <div className="media-body text-left ml-3">
                        <h6 className="text-uppercase mb-1">Nhiều ưu đãi</h6>
                        <p className="text-small mb-0 text-muted">
                          01/01/2024 giảm 30%
                        </p>
                      </div>
            ...
            <div className="container p-0">
              <div className="row">
                <div className="col-lg-6 mb-3 mb-lg-0">
                  <h5 className="text-uppercase">Kết bạn nhé!</h5>
                  <p className="text-small text-muted mb-0">
                    "ngtheson20.01@gmail.com"
                  </p>
                </div>
                <div className="col-lg-6">
                  <form action="#">
